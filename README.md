Cocos2d-x + Nend Icon Ad サンプルゲーム
=====================================
...
## 3. このソースコードをDL
gitがよくわからない場合は右下のZIP Downloadからzipでどうぞ
...
また、"NDK_ROOT"と"COCOS2DX_ROOT"の環境変数をセットしておく。
ADT-環境設定を開く
C/C++ - Build - Environment 選択し、Addボタン押下、以下のような2項目追加
Name:NDK_ROOT
Value:/Applications/android-ndk-r9c
Name:COCOS2DX_ROOT
Value:/Users/MaxiGundan/cocos2d-x-2.2.2
これで、Eclipseからcocos2d-xのNativeビルドができる。
